...
Route::post('/admin/delete_estate', 			['as'=>'delete_estate', 	'uses'=>'EstateController@delete_estate', 'middleware'=>'auth']); // redirect->with
...
Route::post('/admin/delete_article', 				['as'=>'delete_article', 'uses'=>'ArticleController@delete_article', 'middleware'=>'auth']); // redirect->with
...
Route::post('/admin/towns/update_town', 	['as'=>'update_town', 'uses'=>'TownController@update_town', 'middleware'=>'auth']); // popup
Route::post('/admin/towns/delete_town', 	['as'=>'delete_town', 'uses'=>'TownController@delete_town', 'middleware'=>'auth']); // redirect->with
...
Route::post('/admin/districts/update_district', 	['as'=>'update_district', 'uses'=>'DistrictController@update_district', 'middleware'=>'auth']); // popup
Route::post('/admin/districts/delete_district', 	['as'=>'delete_district', 'uses'=>'DistrictController@delete_district', 'middleware'=>'auth']); // redirect->with

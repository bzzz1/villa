<div class="filters_full">
	<div class="filters js_filters">
		<h3>поиск объекта</h3>
			<div class="selects">
				<div class="btn-group">
					<button class='btn btn-default js_filter_click buttons js_commercial' data-commercial='sale'>Купить</button>
					<button class='btn btn-default js_filter_click buttons js_commercial active' data-commercial='rent'>Арендовать</button>
				</div>

@section ('left_sidebar')
	<div class="admin_sidebar_container">
		...
		<a href="/admin" class=" active_my admin_sidebar_button"><i class="fa fa-wrench"></i>Панель управления</a>
		...
		<a href="/admin/articles" class="admin_sidebar_button"><i class="fa fa-list-alt"></i>Новости</a>

@section ('left_sidebar')
	<div class="admin_sidebar_container">
		...
		<a href="{{l('create_estate')}}" class="@if (r() == 'create_estate' || r() == 'change_estate') active_my @endif admin_sidebar_button"><i class="fa fa-home"></i>Добавить объект</a>
		<a href="{{l('admin_estates')}}" class="@if (r() == 'admin_estates') active_my @endif admin_sidebar_button"><i class="fa fa-list"></i>Все объекты</a>
		<a href="{{l('create_article')}}" class="@if (r() == 'create_article' || r() == 'change_article') active_my @endif admin_sidebar_button"><i class="fa fa-bullhorn"></i>Добавить новость</a>
